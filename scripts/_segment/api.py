...
def materialize_keyframe_plan(root_dir, frames_dir, timestamps_path, kf_gap, keyframes_mode, policy_name):
    ...
    keyframes_meta = {
        ...
        "policy_meta": dict(plan.get("policy_meta") or {}),
        "note": "Keyframes remain backward compatible with the legacy uniform layout fields. sks_v1 and motion_energy_v1 use shared fixed-budget bounded relocation on top of the uniform skeleton, while semantic_guarded policies keep legacy guarded refinements.",
    }

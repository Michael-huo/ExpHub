...
def compute_semantic_rows(
    ...
    semantic_delta = _compute_semantic_delta(embeddings)
    semantic_smooth, actual_window = _moving_average(semantic_delta, smooth_window)
    rows = []
        ...
        rows.append(
            {
                ...
                "semantic_delta": float(semantic_delta[idx]),

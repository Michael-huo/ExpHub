...
\toprule
\multirow{2}{*}{Data} & \multirow{2}{*}{Seq.} & \multirow{2}{*}{Path (m)} & \multicolumn{3}{c}{Payload} & \multicolumn{3}{c}{APE RMSE} & \multirow{2}{*}{$|\Delta|/L_{\mathrm{GT}}$ (\%)} \\

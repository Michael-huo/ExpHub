...
### 2.3 `scripts/infer_i2v.py` & `scripts/_infer_i2v_impl.py` (视频生成推理)
- **职责**：
...
### 2.5 `scripts/slam_droid.py` (位姿估计)
...
### 2.6 `scripts/stats_collect.py` (统计出图)
